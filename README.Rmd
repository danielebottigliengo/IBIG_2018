...
The `lab` folder contains all the scripts and documents that can be used to
reproduce the results of the case studies on logistic regression 
(`logistic_case_study`) and survival analysis (`survival_case_study`).

The `slides` folder contains all the documents that were used to build the
